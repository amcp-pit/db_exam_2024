...
ALTER TABLE public.plane DROP CONSTRAINT IF EXISTS plane_point_id_fkey;
ALTER TABLE public.plane DROP CONSTRAINT IF EXISTS plane_vector1_id_fkey;
ALTER TABLE public.plane DROP CONSTRAINT IF EXISTS plane_vector2_id_fkey;
